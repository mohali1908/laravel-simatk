...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('purchase.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Tambah Pengajuan </i></a> <br>  <br>               
